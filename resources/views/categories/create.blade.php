...
<form method="POST" action="{{ route('categories.store') }}" class="flex flex-col max-w-lg gap-5 mx-auto mt-5">
  ...
  <div class="relative pt-8 text-white bg-dark">
    <input type="text" id="name" name="name" class="absolute bottom-0 z-10 w-full px-2 py-1 border-4 border-white peer h-9 bg-dark focus:border-secundary focus:outline-none" value="" />
  ...
  <div class="relative pt-8 text-white bg-dark">
    <input type="text" id="slug" name="slug" class="absolute bottom-0 z-10 w-full px-2 py-1 border-4 border-white peer h-9 bg-dark focus:border-secundary focus:outline-none" value="" />
  ...
  <div class="relative pt-8 text-white bg-dark">
    <input type="text" id="image" name="image" class="absolute bottom-0 z-10 w-full px-2 py-1 border-4 border-white peer h-9 bg-dark focus:border-secundary focus:outline-none" value="" />
