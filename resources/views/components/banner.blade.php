...
<div class="relative h-40 mb-4 overflow-hidden duration-300 bg-cover cursor-pointer sm:h-60 group">
  ...
  <div class="absolute z-50 flex items-end justify-between w-full px-4 duration-300 bottom-3 group-hover:bottom-10 group-hover:items-center">
    <p class="font-semibold italic text-[16px] uppercase">Proximo torneo</p>
    <p class="text-2xl font-neue group-hover:pb-1">{{$time}}</p>
  </div>
  <p class="absolute z-50 w-full px-4 text-center duration-300 destacar -bottom-12 group-hover:bottom-2">Ultima oportunidad para apuntarte</p>
