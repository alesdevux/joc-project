...
<div class="relative h-40 mb-4 overflow-hidden bg-cover cursor-pointer sm:h-60 group">
  ...
  <div class="absolute z-20 flex justify-between w-full h-16 px-6 py-2 scale-125 bg-secundary -bottom-4 -rotate-2 group-hover:bottom-4 md:-rotate-1"></div>
  <div class="absolute z-30 w-full h-12 px-6 scale-105 bg-principal -bottom-14 rotate-1 group-hover:-bottom-4 md:-bottom-16"></div>
