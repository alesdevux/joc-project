<div class="relative h-40 mb-4 overflow-hidden bg-cover cursor-pointer sm:h-60 bg-chess group">
  ...
  <div class="absolute top-0 z-0 w-full h-full bg-black/20 group-hover:bg-black/25"></div>
</div>