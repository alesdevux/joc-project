...
<div class="relative h-40 mb-4 overflow-hidden bg-cover cursor-pointer sm:h-60 group">
  ...
  <div class="absolute z-20 flex justify-between w-full h-16 px-6 py-2 scale-125 bg-secondary -bottom-4 -rotate-[1deg] group-hover:bottom-4 md:-rotate-[0.75deg]"></div>
