...
<div class="relative h-40 mb-4 overflow-hidden bg-cover cursor-pointer sm:h-60 group duration-300">
  <div class="absolute z-50 text-white left-4 top-2">
    <h2 class="h2">{{$name}}</h2>
    <h4 class="uppercase">Arena rapida 10'</h4>
  </div>
  <div class="absolute z-50 flex items-end justify-between w-full px-4 bottom-3 group-hover:bottom-10 group-hover:items-center duration-300">
    <p class="font-semibold italic text-[16px] uppercase">Proximo torneo</p>
    <p class="text-2xl font-neue group-hover:pb-1">02:59:48</p>
  </div>
  <p class="absolute z-50 w-full px-4 text-center destacar -bottom-12 group-hover:bottom-2 duration-300">Ultima oportunidad para apuntarte</p>
  ...
  <div class="absolute top-0 z-10 w-full h-full bg-black/20 group-hover:bg-black/25 duration-300"></div>
